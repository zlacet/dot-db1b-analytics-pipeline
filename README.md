...
- **Fare Analysis** — planned
  - *Where and when are fares moving, and is pricing power increasing or eroding?*
...
[Tableau Dashboard](https://github.com/zlacet/dot-db1b-analytics-pipeline/blob/main/tableau/airline_fare_analysis.twbx)
