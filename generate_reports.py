...
def _pdf_sections(base_metrics: dict, top_markets_n: int) -> dict:
    ...
    best_growth, worst_growth = best_worst(markets, "passenger_growth_pct")
    best_fare, worst_fare = best_worst(markets, "fare_change_pct")
    best_carrier_pax, worst_carrier_pax = best_worst(carriers, "total_passengers")
    best_carrier_fare, worst_carrier_fare = best_worst(carriers, "avg_fare")
    best_carrier_share, worst_carrier_share = best_worst(carriers, "avg_market_share_pct")
