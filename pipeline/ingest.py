...
Reads whatever quarterly DB1BMarket CSV file(s) are found in data/raw/,
combines them, selects the required fields, and bulk-loads them into the
raw_airline_data table.
