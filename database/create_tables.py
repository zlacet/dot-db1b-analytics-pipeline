...
tables for the Airline Fare Variance Platform:
    raw_airline_data, market_summary, carrier_summary, fare_variance_summary,
    ingest_log, validated_quarters

Connection settings can be overridden with environment variables:
    PGHOST      (default: localhost)
    PGPORT      (default: 5432)
    PGDATABASE  (default: airline_fare_variance_platform)
